...
export default function FileCard({ file, index = 0, onPreview }) {
  ...
  return (
    <motion.div
      ...
      className="card flex items-center justify-between gap-4 group hover:border-white/20 transition-all"
    >
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        {isPreviewable && onPreview && (
          <button
            ...
            className="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-white/70 hover:text-white transition-all duration-300 text-sm font-medium"
            title="Preview file"
          >
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-brand-500/10 hover:bg-brand-500/20 text-brand-400 hover:text-brand-300 border border-brand-500/20 hover:border-brand-500/30 transition-all duration-300 text-sm font-medium disabled:opacity-50"
        >
          {downloading ? (
